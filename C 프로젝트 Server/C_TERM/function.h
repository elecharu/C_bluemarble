...
//////////////	¸Ê »çÀÌÁî	//////////////
void game_size() {
	system("mode con cols=198 lines=53 | title ºÎ¸£¸¶ºí Server");
}
void info_size() {
	system("mode con cols=100 lines=33 | title ºÎ¸£¸¶ºí Server");
}
void intro_size() {
	system("mode con cols=161 lines=53 | title ºÎ¸£¸¶ºí Server");
}
...
// intro[number] = ¼ýÀÚ¸¦ ³ÖÀ¸¸é ¸î¹ø¤Š ÁÙ ±îÁö ÇÒ²«Áö Á¤ÇÑ´Ù. Áï ÀÌ°É·Î º»ÀÎÀÌ ÇÏ°í ½ÍÀº°Å ÇÏ¸é µÈ´Ù.
char* intro[23] = {
		{"                                                                                                                                                                "},
		{"                                                                                                                                                                "},
		{"                                                                                                            ¡á¡á                                                "},
...
int draw_intro(int state) {
	...
	CLR;
	gotoxy(75, 38);	printf("°Ô ÀÓ ½Ã ÀÛ");
	//gotoxy(77, 41);	printf("°Ô ÀÓ Á¾ ·á");
	gotoxy(75, 41);	printf("°Ô ÀÓ Á¤ º¸");
	gotoxy(72, 38);	printf("¢º");

	gotoxy(180, 60);
	// Ä­À» 3°³ ¸¸µé°í ½ÍÀ¸¸é x, y ÀÇ °ªÀÌ 3¾¿ Â÷ÀÌ³ª´Ï Âü°í
	...
	int infor() {
		system("cls");
		CLR;
		system("mode con cols=110 lines=20 | title ºÎ¸£¸¶ºí Server");
		printf("\n\n\n");
